...
(function () {
  ...
  style.textContent = `
    ...
    @media(max-width:768px){
      ...
      /* Footer mobile */
      #footer{ background:#000 !important; margin-top:0 !important; }
      .footer-inner{
        padding:20px 5%;
      ...
      /* Works / Blog 內頁左右 padding 24px */
      #works-body,
      #blog-body,
      .works-category,
      .blog-category{ padding-left:24px !important; padding-right:24px !important; }
    }
  `;
